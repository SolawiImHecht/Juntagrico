"""
Django settings for solawiimhecht project.
"""
...
ALLOWED_HOSTS = ['solawiimhecht.juntagrico.science', 'localhost',]
...
ROOT_URLCONF = 'solawiimhecht.urls'

DATABASES = {
    'default': {
        'ENGINE': os.environ.get('JUNTAGRICO_DATABASE_ENGINE','django.db.backends.sqlite3'), 
        'NAME': os.environ.get('JUNTAGRICO_DATABASE_NAME','solawiimhecht.db'), 
...
WSGI_APPLICATION = 'solawiimhecht.wsgi.application'
...
"""
     juntagrico Settings
"""
ORGANISATION_NAME = "SoLaWi Im Hecht"
ORGANISATION_LONG_NAME = "SoLaWi Im Hecht"
ORGANISATION_ADDRESS = {"name":"SoLaWi Im Hecht", 
            "street" : "Furtstrasse",
            "number" : "18",
            "zip" : "8155",
            "city" : "Niederhasli",
